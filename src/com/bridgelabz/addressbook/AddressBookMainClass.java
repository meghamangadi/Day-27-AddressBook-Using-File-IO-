...
public class AddressBookMainClass {
	...
	public void addContacts() {
		...
		case 2 :
			...
			addressbooks.editContact(nameToEdit,editFirstName, editLastName, editAddress, editCity, editState, editZip, editPhoneNumber, editEmail);
			addressbooks.addContacts();
	}
		
		
}
	public void editContact(String name,String editFirstName,String editLastName,String editAddress,String editCity,String editState,int  editZip,long editPhoneNumber,String editEmail ) {
	 ...
	 public void displayContacts(AddressBook addressBook){
		 ...
		 for (int i =0;i <=contactDetails.size()-1;i++) {
			 ...
			 System.out.println("FirstName :"+contactperson.getFirstName()+"      LastName :"+contactperson.getLastName()
			 		...
			 		"       State :"+contactperson.getState()+"     Zip :"+contactperson.getZip()+"     Phone Number :"+contactperson.getPhoneNumber()); 
			 }else {
